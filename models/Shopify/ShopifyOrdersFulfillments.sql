...
{% for i in results_list %}
    ...
    FROM (
        ...
        fulfillments.VALUE:tracking_company,
        fulfillments.VALUE:shipment_status,
        fulfillments.VALUE:tracking_number::VARCHAR as fulfillments_tracking_number,
        fulfillments.VALUE:tracking_numbers,
        fulfillments.VALUE:tracking_url,
        fulfillments.VALUE:tracking_urls,
        receipt.VALUE:testcase,
        receipt.VALUE:authorization,
        COALESCE(fulfillments_line_items.VALUE:id::VARCHAR,'') as fulfillments_line_items_id,
        fulfillments_line_items.VALUE:variant_id,
        fulfillments_line_items.VALUE:title::VARCHAR as fulfillments_line_items_title,
        fulfillments_line_items.VALUE:quantity,
        fulfillments_line_items.VALUE:price::VARCHAR as fulfillments_line_items_price,
        fulfillments_line_items.VALUE:sku::VARCHAR as fulfillments_line_items_sku,
        fulfillments_line_items.VALUE:variant_title,
        fulfillments_line_items.VALUE:vendor,
        fulfillments_line_items.VALUE:fulfillment_service::VARCHAR as fulfillments_line_items_fulfillment_service,
        fulfillments_line_items.VALUE:product_id::VARCHAR as fulfillments_line_items_product_id,
        fulfillments_line_items.VALUE:requires_shipping,
        fulfillments_line_items.VALUE:taxable,
        fulfillments_line_items.VALUE:gift_card,
        ...
        fulfillments_line_items.VALUE:properties,
        fulfillments_line_items.VALUE:product_exists,
        fulfillments_line_items.VALUE:fulfillable_quantity,
        fulfillments_line_items.VALUE:grams,
        fulfillments_line_items.VALUE:total_discount,
        fulfillments_line_items.VALUE:fulfillment_status,
        fulfillments_line_items.VALUE:tax_lines,
        fulfillments_line_items.VALUE:origin_location,
        ...
        fulfillments.tracking_number as  as fulfillments_tracking_number,
        fulfillments.tracking_numbers as tracking_numbers,
        fulfillments.tracking_url as tracking_url,
        fulfillments.tracking_urls as tracking_urls,
        receipt.testcase as testcase,
        receipt.authorization as authorization,
        COALESCE(CAST(fulfillments_line_items.id as string),'') as fulfillments_line_items_id,
        fulfillments_line_items.variant_id as variant_id,
        fulfillments_line_items.title as fulfillments_line_items_title,
        fulfillments_line_items.quantity as quantity,
        fulfillments_line_items.price as fulfillments_line_items_price,
        fulfillments_line_items.sku as as fulfillments_line_items_sku,
        fulfillments_line_items.variant_title as variant_title,
        fulfillments_line_items.vendor as vendor,
        fulfillments_line_items.fulfillment_service as fulfillment_service,
        fulfillments_line_items.product_id as  as fulfillments_line_items_product_id,
        fulfillments_line_items.requires_shipping as requires_shipping,
        fulfillments_line_items.taxable as taxable,
        fulfillments_line_items.gift_card as gift_card,
        ...
        fulfillments_line_items.properties as properties,
        fulfillments_line_items.product_exists as product_exists,
        fulfillments_line_items.fulfillable_quantity as fulfillable_quantity,
        fulfillments_line_items.grams as grams,
        fulfillments_line_items.total_discount as total_discount,
        fulfillments_line_items.fulfillment_status as fulfillment_status,
        fulfillments_line_items.tax_lines as tax_lines,
        fulfillments_line_items.origin_location as origin_location,
