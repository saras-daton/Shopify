...
{% for i in results_list %}
    ...
    select
        ...
        {{extract_nested_value("fulfillments","id","varchar")}} as fulfillments_id,
        ...
        {{extract_nested_value("fulfillments","orders_id","varchar")}} as fulfillments_orders_id,
        ...
        {{extract_nested_value("fulfillments_line_items","admin_graphql_api_id","varchar")}} as line_items_admin_graphql_api_id,
        {{extract_nested_value("fulfillments_line_items","fulfillable_quantity","varchar")}} as line_items_fulfillable_quantity,
        {{extract_nested_value("fulfillments_line_items","fulfillment_service","varchar")}} as line_items_fulfillment_service,
        {{extract_nested_value("fulfillments_line_items","gift_card","varchar")}} as line_items_gift_card,
        {{extract_nested_value("fulfillments_line_items","grams","varchar")}} as line_items_grams,
        {{extract_nested_value("fulfillments_line_items","name","varchar")}} as line_items_name,
        ...
        {{extract_nested_value("fulfillments_line_items","product_exists","varchar")}} as line_items_product_exists,
        {{extract_nested_value("fulfillments_line_items","product_id","varchar")}} as line_items_product_id,
        ...
        {{extract_nested_value("fulfillments_line_items","requires_shipping","varchar")}} as line_items_requires_shipping,
        {{extract_nested_value("fulfillments_line_items","sku","varchar")}} as line_items_sku,
        {{extract_nested_value("fulfillments_line_items","taxable","varchar")}} as line_items_taxable,
        {{extract_nested_value("fulfillments_line_items","title","varchar")}} as line_items_title,
        ...
        {{extract_nested_value("fulfillments_line_items","variant_id","varchar")}} as line_items_variant_id,
        {{extract_nested_value("fulfillments_line_items","variant_inventory_management","varchar")}} as line_items_variant_inventory_management,
        {{extract_nested_value("fulfillments_line_items","variant_title","varchar")}} as line_items_variant_title,
        ...
        {{extract_nested_value("fulfillments_line_items","fulfillment_status","varchar")}} as line_items_fulfillment_status,
        ...
        {{extract_nested_value("fulfillments_line_items","vendor","varchar")}} as line_items_vendor,
