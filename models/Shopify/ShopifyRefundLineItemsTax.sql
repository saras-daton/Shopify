...
{% for i in results_list %}
    ...
    from (
        ...
        {{extract_nested_value("line_item","price_set","numeric")}} as line_item_price_set,
        {{extract_nested_value("line_item","total_discount_set","numeric")}} as line_item_total_discount_set,
