...
{% for i in relations %}
    ...
    {% endif %}
        ...
        {% endif %}
        cast(a.id as string) as refund_id,
        ...
        {{extract_nested_value("line_item","id","numeric")}} as line_item_id,
        {{extract_nested_value("line_item","variant_id","numeric")}} as line_item_variant_id,
        ...
        {{extract_nested_value("line_item","product_id","numeric")}} as line_item_product_id,
        ...
        {{extract_nested_value("line_item","product_exists","boolean")}} as line_item_id_product_exists,
        ...
        from {{i}} a
            ...
            {% endif %}
        qualify dense_rank() over (partition by a.id, {{extract_nested_value('refund_line_items','id','numeric')}}, {{extract_nested_value("line_item","variant_id","numeric")}} order by _daton_batch_runtime desc) = 1
        {% if var('currency_conversion_flag') %}
