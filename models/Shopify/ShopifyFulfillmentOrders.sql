...
{% for i in results_list %}
    ...
    {% endif %}
        ...
        safe_cast(a.shop_id as string) as shop_id,
        safe_cast(order_id as string) as order_id,
        safe_cast(assigned_location_id as string) as assigned_location_id,
        request_status,
        status,
        supported_actions,
        ...
        safe_cast({{ dbt.dateadd(datepart="hour", interval=hr, from_date_or_timestamp="fulfill_at") }} as {{ dbt.type_timestamp() }}) as fulfill_at,
