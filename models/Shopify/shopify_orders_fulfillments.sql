{% if var('shopify_orders_fulfillments') %}
{{ config( enabled = True ) }}
{% else %}
...
{% for i in results_list %}
    ...
    FROM (
        ...
        fulfillments.VALUE:tracking_number,
        ...
        fulfillments_line_items.VALUE:sku,
        fulfillments_line_items.VALUE:variant_title,
        fulfillments_line_items.VALUE:vendor,
        fulfillments_line_items.VALUE:fulfillment_service,
        fulfillments_line_items.VALUE:product_id,
        ...
        fulfillments_line_items.sku as sku,
        ...
        fulfillments_line_items.product_id as product_id,
