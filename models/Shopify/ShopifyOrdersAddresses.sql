...
{% for i in results_list %}
    ...
    {% endif %}
        ...
        {{extract_nested_value("billing_address","address_phone","string")}} as billing_address_phone,
        {{extract_nested_value("billing_address","address_city","string")}} as billing_address_city,
        {{extract_nested_value("billing_address","address_zip","string")}} as billing_address_zip,
        {{extract_nested_value("billing_address","address_province","string")}} as billing_address_province,
        {{extract_nested_value("billing_address","address_country","string")}} as billing_address_country,
        {{extract_nested_value("billing_address","address_last_name","string")}} as billing_address_last_name,
        ...
        {{extract_nested_value("billing_address","provinceas_code","string")}} as billing_address_provinceas_code,
        ...
        {{extract_nested_value("shipping_address","address_phone","string")}} as shipping_address_phone,
        {{extract_nested_value("shipping_address","address_city","string")}} as shipping_address_city,
        {{extract_nested_value("shipping_address","address_zip","string")}} as shipping_address_zip,
        {{extract_nested_value("shipping_address","address_province","string")}} as shipping_address_province,
        {{extract_nested_value("shipping_address","address_country","string")}} as shipping_address_country,
        {{extract_nested_value("shipping_address","address_last_name","string")}} as shipping_address_last_name,
        ...
        {{extract_nested_value("shipping_address","provinceas_code","string")}} as shipping_address_province_code,
