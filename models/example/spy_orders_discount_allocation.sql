...
{% for i in results_list %}
    ...
    FROM (
        ...
        properties.VALUE:name as line_items_properties_name,
        properties.VALUE:value as line_items_properties_value,
        ...
        discount_allocations.VALUE:discount_application_index as discount_application_index,
        {% else %}
        ...
        properties.name as line_items_properties_name,
        properties.value as line_items_properties_value,
